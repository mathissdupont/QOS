...
- [~] **Step 3 — Port + device enumeration.** (3a done) Detect connected ports via PORTSC; (3b
  todo) reset them, assign slots and addresses via control transfers; read device/config
  descriptors.
